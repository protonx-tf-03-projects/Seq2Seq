...
used `Vietnamese-English` and added two `Attention mechanisms`: [Luong attention](https://arxiv.org/pdf/1508.04025.pdf) and [Bahdanau attention](https://arxiv.org/pdf/1409.0473.pdf)
