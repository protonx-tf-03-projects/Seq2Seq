...
from model.tests.model_test import Seq2SeqEncode, Seq2SeqDecode, AttentionSeq2SeqDecode, EncoderDecoder
...
if __name__ == '__main__':
    ...
    decoder = Seq2SeqDecode(vocab_size, embedding_size, hidden_unit)
